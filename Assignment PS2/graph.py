...
# Collaborators:
# Time: 26min
# 2021-4-3 09:20 - 09:46 review the concept of graph, node, edge
#                        construct the WeightedEdge and Digraph class - problem 1
...
class Digraph(object):
    ...
    def __init__(self):
        self.nodes = set([])
        self.edges = {}  # must be a dict of Node -> list of edges (its children)
